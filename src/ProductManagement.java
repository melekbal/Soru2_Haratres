...
public class ProductManagement {
    ...
    private void addProductToCart() {
        ...
        cart.add(new CartItem(productToAdd.getName(), quantity, productToAdd.getPrice(), totalPrice));
        ...
        if (cart.size() >= 2) {
            ...
            if (firstItem.getPrice() > secondItem.getPrice()) {
                double discount = secondItem.getPrice();
                firstItem.setTotalPrice((firstItem.getPrice() - discount) * firstItem.getQuantity());
            }
        }
    }
